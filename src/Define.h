...
#define couleurImageMarron 187, 122, 87, 255 //couleur image
...
/* typedef enum {ACTIF=0, INACTIF=1, INVISIBLE=2} EtatBouton; //pour afficher les boutons en gris ou en noir */
